...
export const USER_ACCOUNTS: UserAccount[] = [
  {
    ...
    fullName: 'Jacques Desrosiers',
    role: 'ADMIN_CEP',
    roleTitle: 'Président du CEP (Représentant de la Presse)',
  ...
  },
  {
    ...
    password: 'CepPassword2026!',
    fullName: 'Patrick Saint-Hilaire',
    role: 'ADMIN_CEP',
    roleTitle: 'Conseiller Électoral (Conférence Épiscopale)',
    permissions: ['system.superadmin', '*.*'],
    scope: { departments: ['ALL'], elections: ['ALL'], communes: ['ALL'] },
  },
  {
    ...
    password: 'CepPassword2026!',
    fullName: 'Rose Magalie Thérèse Georges',
    role: 'ADMIN_CEP',
    roleTitle: 'Conseillère Électorale (Secteur Droits Humains)',
    permissions: ['system.superadmin', '*.*'],
    scope: { departments: ['ALL'], elections: ['ALL'], communes: ['ALL'] },
  },
  {
    ...
    password: 'CepPassword2026!',
    fullName: 'Marie Florence Mathieu',
    role: 'ADMIN_CEP',
    roleTitle: 'Conseillère Électorale (Conseil de l\'Université)',
    permissions: ['system.superadmin', '*.*'],
    scope: { departments: ['ALL'], elections: ['ALL'], communes: ['ALL'] },
  },
  {
    ...
    password: 'CepPassword2026!',
    fullName: 'Yves Marie Édouard',
    role: 'ADMIN_CEP',
    roleTitle: 'Conseiller Électoral (Droits des Femmes)',
    permissions: ['system.superadmin', '*.*'],
    scope: { departments: ['ALL'], elections: ['ALL'], communes: ['ALL'] },
  },
  {
    ...
    password: 'CepPassword2026!',
    fullName: 'Schnaida Adely',
    role: 'ADMIN_CEP',
    roleTitle: 'Conseillère Électorale (Secteur Vodou)',
    permissions: ['system.superadmin', '*.*'],
    scope: { departments: ['ALL'], elections: ['ALL'], communes: ['ALL'] },
  },
  {
